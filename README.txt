...
Before runnig the code, run mypy --install-types
...
2) `GET /statistics`
3) mypy fixes
4) tests are all in 1 file, maybe redistrbute to few files? I got 1 point deduction last time for this
5) some tests are too heavy. find a way to make them shorter and easier to read
6) Some errors are not infomrmative: add input infomration in output messages, not just static message string.
